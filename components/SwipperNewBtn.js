  ...
  return (
    <div className="swiper-nav-btns    h-[300px] ">
      <div className="flex  tablet:flex-col gap-4 relative justify-between tablet:justify-center">
        <span
          className=" animated-button  group rounded-full flex   relative  overflow-hidden justify-center items-center w-[50px] h-[50px]"
        ...
        <span
          className="bg-[#000]  tablet:hidden rounded-full animated-button group flex relative justify-center items-center w-[50px] h-[50px]"
  ...
  return (
    <div className="swiper-nav-btns hidden tablet:block   tablet:ml-[-200px] h-[300px] ">
      <div className="flex flex-col gap-4 relative justify-end">
        ...
        <span
          className="bg-[#000] mx-auto rounded-full animated-button group flex relative justify-end items-end w-[50px] h-[50px]"
          onClick={() => swiper.slideNext()}
        >
