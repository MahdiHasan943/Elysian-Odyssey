  ...
  return (
    <>
      <div
        ...
        id="Roadmap"
      >
        <div className="min-h-[7600px] mt-[-200px] pt-[200px] bg-[black]  mb-[-5px] smallest:min-h-[7600px] moreSmall:min-h-[7600px]   lg:min-h-[4300px] lg:max-h-[4300px] relative overflow-hidden ">
          ...
          <div className="absolute top-0 bg-[#221E1B] left-0 h-full w-full">
            {/* <Image
